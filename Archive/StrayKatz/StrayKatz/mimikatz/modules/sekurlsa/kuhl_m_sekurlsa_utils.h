...
typedef struct _KIWI_MSV1_0_LIST_61_ANTI_straykatz {
	struct _KIWI_MSV1_0_LIST_61_ANTI_straykatz *Flink;
	struct _KIWI_MSV1_0_LIST_61_ANTI_straykatz *Blink;
	PVOID unk0;
	ULONG unk1;
	PVOID unk2;
	ULONG unk3;
	...
	ULONG unk22;
	PVOID CredentialManager;
} KIWI_MSV1_0_LIST_61_ANTI_straykatz, *PKIWI_MSV1_0_LIST_61_ANTI_straykatz;
