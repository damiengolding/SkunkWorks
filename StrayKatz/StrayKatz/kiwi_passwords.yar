...
{
	meta:
		description		= "straykatz"
		author			= "AUTHOR (NOMDEPLUME)"
		tool_author		= "AUTHOR (NOMDEPLUME)"
...
rule straykatz_lsass_mdmp
{
	meta:
		description		= "LSASS minidump file for straykatz"
		author			= "AUTHOR (NOMDEPLUME)"
...
rule straykatz_kirbi_ticket
{
	meta:
		description		= "KiRBi ticket for straykatz"
		author			= "AUTHOR (NOMDEPLUME)"
