...
#define NET_MODULE
#if defined(_M_ARM64)
	#define straykatz_ARCH L"arm64"
#elif defined(_M_X64)
	#define straykatz_ARCH L"x64"
#elif defined(_M_IX86)
	#define straykatz_ARCH L"x86"
#endif

#define straykatz				L"straykatz"
#define straykatz_VERSION		L"2.2.0"
#define straykatz_CODENAME		L"A La Vie, A L\'Amour"
#define straykatz_MAX_WINBUILD	L"19041"
#define straykatz_FULL			straykatz L" " straykatz_VERSION L" (" straykatz_ARCH L") #" straykatz_MAX_WINBUILD L" " TEXT(__DATE__) L" " TEXT(__TIME__)
#define straykatz_SECOND			L"\"" straykatz_CODENAME L"\""
#define straykatz_DEFAULT_LOG	straykatz L".log"
#define straykatz_DRIVER			L"mimidrv"
#define straykatz_KERBEROS_EXT	L"kirbi"
#define straykatz_SERVICE		straykatz L"svc"

#if defined(_WINDLL)
	#define straykatz_AUTO_COMMAND_START		0
#else
	#define straykatz_AUTO_COMMAND_START		1
#endif

#if defined(_POWERKATZ)
	#define straykatz_AUTO_COMMAND_STRING	L"powershell"
#else
	#define straykatz_AUTO_COMMAND_STRING	L"commandline"
#endif
...
DWORD straykatz_NT_MAJOR_VERSION, straykatz_NT_MINOR_VERSION, straykatz_NT_BUILD_NUMBER;
